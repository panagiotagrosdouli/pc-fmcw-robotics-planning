...
def main():
    ...
    for h,g in q.groupby('horizon_steps'):
        ...
        rows.append({'horizon_steps':h,'n_runs':len(g),'fusion_minus_persistence_mae_ms':mean,'ci95_lo':lo,'ci95_hi':hi,'wilcoxon_p':p})
