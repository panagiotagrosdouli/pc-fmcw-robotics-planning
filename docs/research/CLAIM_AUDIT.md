...
| Lightweight route-constrained decision scoring has a stable latency result | NOT SUPPORTED | Hosted-run timings varied materially across otherwise identical evidence runs. Retain timing only as a diagnostic; do not claim embedded or end-to-end real-time capability. |
